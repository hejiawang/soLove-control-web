...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,imagePath:"E:\\temp"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
...
, toolbars: [["source","fullscreen","undo","redo","link","unlink","print","preview","insertimage","emotion","insertvideo","date","time","bold","italic","underline","fontborder","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","indent","removeformat","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable"]]
