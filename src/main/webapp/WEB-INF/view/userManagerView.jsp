	...
	<div class="main-container" id="main-container">
		...
		<div class="main-content">
			...
			<div class="page-content">
				...
				<button id="userViewClose" onclick="soLove.userManager.userView.userViewClose();" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;" >关闭</button>
				...
				<div class="tabbable tabs-left ">
					...
					<div class="tab-content">
						 ...
						 <div class="tab-pane active" id="infoPage">
						 	<form class="form-horizontal validation-form" id="baseInfo-form" role="form" action="javascript:void(0)">
						 ...
						 <div class="tab-pane" id="detailPage">
						 	<form class="form-horizontal validation-form" id="detailInfo-form" role="form" action="javascript:void(0)">
							 	<table style="width:100%">
								     <tr>
										 <td>
							 	...
							 	<table style="width:100%">
							 		<tr>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage1_src" name="userImage1_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage1" name="userImage1"/>
									     	<input type="file" id="userImage1_file" name="userImage1_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
									     <td style="text-align:center;width:20%">
									     	<img id="userImage2_src" name="userImage2_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage2" name="userImage2"/>
									     	<input type="file" id="userImage2_file" name="userImage2_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
									     </td>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage3_src" name="userImage3_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage3" name="userImage3"/>
									     	<input type="file" id="userImage3_file" name="userImage3_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
									     <td style="text-align:center;width:20%">
									     	<img id="userImage4_src" name="userImage4_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage4" name="userImage4"/>
									     	<input type="file" id="userImage4_file" name="userImage4_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
									     </td>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage5_src" name="userImage5_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage5" name="userImage5"/>
									     	<input type="file" id="userImage5_file" name="userImage5_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
								 	</tr>
								 	<tr>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage6_src" name="userImage6_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage6" name="userImage6"/>
									     	<input type="file" id="userImage6_file" name="userImage6_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
									     <td style="text-align:center;width:20%">
									     	<img id="userImage7_src" name="userImage7_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage7" name="userImage7"/>
									     	<input type="file" id="userImage7_file" name="userImage7_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
									     </td>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage8_src" name="userImage8_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage8" name="userImage8"/>
									     	<input type="file" id="userImage8_file" name="userImage8_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
									     <td style="text-align:center;width:20%">
									     	<img id="userImage9_src" name="userImage9_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage9" name="userImage9"/>
									     	<input type="file" id="userImage9_file" name="userImage9_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
									     </td>
									     <td style="text-align:center;width:20%">
									     	<img id="userImage10_src" name="userImage10_src" src="<%= basePath%>resources/upload/default_img.png" style="width:200px; height:270px;">
									     	<input type="hidden" id="userImage10" name="userImage10"/>
									     	<input type="file" id="userImage10_file" name="userImage10_file" style="display:none"/>
									     	<button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;">删除</button>
										 </td>						      
								 	</tr>
							 	</table>
						 ...
						 <div class="tab-pane" id="parentPage">
						 	<button onclick="soLove.userManager.userView.js_raiseParent()" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;" >增加信息</button>
						 	<form class="form-horizontal validation-form" id="parentInfo-form" role="form" action="javascript:void(0)">
							 	<table style="width:100%">
							 		<div>
								 		<tr>
								 			<td > 
										...
										<tr>
											<td>
												<label></label>
												<span><button onclick="" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;" >删除信息</button></span>
											</td>
										</tr>
									</div>
							 	</table>
						 ...
						 <div class="tab-pane" id="childrenPage">
						 	<button onclick="soLove.userManager.userView.js_raiseChildren()" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;" >增加信息</button>
						 	<form class="form-horizontal validation-form" id="childrenInfo-form" role="form" action="javascript:void(0)">
							 	<table style="width:100%">
							 		<div>
								 		<tr>
								 			<td > 
						 ...
						 <div class="tab-pane" id="hobbyPage">
						 	<button onclick="soLove.userManager.userView.js_raiseHobby()" class="btn btn-success btn-next" data-last="Finish" style="margin-bottom:15px; margin-left:15px;" >增加信息</button>
						 	<form class="form-horizontal validation-form" id="hobbyInfo-form" role="form" action="javascript:void(0)">
							 	<table style="width:100%">
							 		<tr> 
							 			<td> 
						 ...
						 <div class="tab-pane" id="matePage">
						 	<form class="form-horizontal validation-form" id="mateInfo-form" role="form" action="javascript:void(0)">
							 	<table style="width:100%">
									<tr>
										 <td>
